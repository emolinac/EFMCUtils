...
Double_t GetMeanpt2Signori(Double_t Zh, Double_t zhat, Double_t norm, Double_t beta, Double_t delta, Double_t gamma){
  // Returns meanpt2, which is represented by Signori et al. function
...
Double_t GetMeanpt2Beta(Double_t Zh, Double_t norm, Double_t alpha, Double_t beta){
  // Returns meanpt2, which is represented by a Beta distribution
...
Double_t GetMeanPt2Signori(Double_t* x, Double_t* pars){
  // Returns analytic expression of MeanPt2 with Meanpt2 being represented by Signori et al. function
  // Format is such that fitting is direct
  Double_t Zh = x[0];
  // meanpt2 parameters
...
Double_t GetMeanPt2Beta(Double_t* x, Double_t* pars){
  // Returns analytic expression of MeanPt2 with Meanpt2 being represented by a Beta distribution
  // Format is such that fitting is direct
  Double_t Zh = x[0];
  // meanpt2 parameters
