...
void myText(Double_t x,Double_t y,Color_t color, const char *text,Double_t tsize,Double_t langle) {
...
void myBoxText(Double_t x, Double_t y,Double_t boxsize,Int_t mcolor,const char *text,Int_t mlinecolor, Int_t mlinestyle, Int_t fstyle, Double_t tsize) 
{
  ...
  Double_t tsize2 = 0.06;
  Double_t y1=y-0.25*tsize2;
  Double_t y2=y+0.25*tsize2;
  Double_t x2=x-0.3*tsize2;
  ...
  mline.SetLineColor(mlinecolor);
  mline.SetLineStyle(mlinestyle);
...
{
  Double_t new_tsize=22;
  TMarker *marker = new TMarker(x-(0.4*0.05),y,8);
...
void myLineText(Double_t x, Double_t y,Double_t boxsize,Int_t mcolor,const char *text,Int_t lstyle, const Double_t tsize)
{
    // Double_t tsize=0.06;
    TLatex l; l.SetTextAlign(12);
    l.SetTextSize(tsize);
